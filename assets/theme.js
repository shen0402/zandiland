...
(typeof window.BOLD !== 'undefined' && typeof window.BOLD.recurring_orders !== 'undefined' && typeof window.BOLD.recurring_orders.app !== 'undefined' && (BOLD.recurring_orders.app.renderLineItems(state)));
        ...
        function(item, index) {
          ...
          var productDetailsList = this._createProductDetailsList(
            ...
            item.properties
                    ...
                    var recurring_desc = document.createElement('span');
		  recurring_desc.classList = "bold_ro_desc";
		  recurring_desc.setAttribute('data-product-id', item.id + '-' + (item.line-1));
          productDetailsList.push(recurring_desc);

          var bold_properties = document.createElement('span');
          bold_properties.classList = "bold_load_cart_item_properties";
          productDetailsList.push(bold_properties);
...
(typeof window.BOLD !== 'undefined' && typeof window.BOLD.common !== 'undefined' && typeof window.BOLD.common.cartDoctor !== 'undefined' && (json = window.BOLD.common.cartDoctor.fixItem(json)));
    ...
    _updateCartPopupContent: function(item) {
      ...
      (typeof this !== 'undefined' && this.cartPopup !== 'undefined' && this.cartPopup !== 'undefined' && this.cartPopup.querySelector('.recurring_desc') && (this.cartPopup.querySelector('.recurring_desc').innerHTML = '<span class="bold_ro_desc" data-product-id="' + item.id + '-' + (item.line-1) + '"></span>'));
...
(typeof window.BOLD !== 'undefined' && typeof window.BOLD.recurring_orders !== 'undefined' && typeof window.BOLD.recurring_orders.app !== 'undefined' && (BOLD.recurring_orders.app.renderLineItems(cart)));
})
        .catch(function(error) {
          // eslint-disable-next-line no-console
          console.log(error);
